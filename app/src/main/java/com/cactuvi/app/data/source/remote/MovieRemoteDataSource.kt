...
/**
 * Remote data source for movies (VOD). Handles all API calls related to movies.
 *
...
class MovieRemoteDataSource(
    ...
    /** Fetch VOD streams from API. Returns streaming ResponseBody for incremental parsing. */
