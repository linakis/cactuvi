...
/**
 * Sealed class representing detected differences between old and new content states. Used by
 * ReactiveUpdateManager to apply granular UI updates without full screen reloads.
 */
