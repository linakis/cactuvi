...
/**
 * Remote data source for live channels. Handles all API calls related to live TV.
 *
...
class LiveRemoteDataSource(
    ...
    /** Fetch live streams from API. Returns streaming ResponseBody for incremental parsing. */
