...
/**
 * Metadata for tracking cache validity without loading full datasets. Enables fast cache validation
 * (~50ms vs ~8000ms for full data load). Also tracks background sync status for
...
data class CacheMetadataEntity(
    ...
    /**
     * Current load status for async write tracking: "IDLE", "LOADING", "SUCCESS", "PARTIAL",
     * "ERROR" Used to track foreground data loads and enable cache merge on retry.
     */
