...
/**
 * Centralized performance logging utility for debugging cache loading and data pipeline
 * performance. Only logs in DEBUG builds to minimize overhead in production.
 */
object PerformanceLogger {
    ...
    /**
     * Measure and log the execution time of a code block. Usage: measureTime("operation name") { /*
     * code to measure */ }
     */
    ...
    /**
     * Log a phase transition in a multi-step operation. Useful for tracking progress through
