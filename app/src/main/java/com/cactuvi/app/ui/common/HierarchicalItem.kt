...
object HierarchicalItemHelper {
    ...
    fun getSelectedCategories(
        ...
        groups.filter { it.isChecked && !it.isIndeterminate }.forEach { group ->
            selectedCategories.addAll(group.getChildNames())
        }
        
        // Add individually checked categories from indeterminate groups
        displayList.filterIsInstance<HierarchicalItem.CategoryItem>()
            .filter { it.isChecked }
    ...
    fun updateCategoryChecked(
        ...
        return displayList.filterIsInstance<HierarchicalItem.CategoryItem>()
    ...
    fun updateParentState(
        ...
        val checkedCategories = displayList.filterIsInstance<HierarchicalItem.CategoryItem>()
