...
/**
 * ViewModel for Live TV screen. Handles live channel data and navigation state using MVVM + UDF
 * pattern.
 *
 * Extends ContentViewModel to reuse shared navigation and state management logic. Supports grouping
 * by language/region using "|" separator (configurable in settings).
 */
@HiltViewModel
