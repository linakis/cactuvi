...
class LiveChannelPagingAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_live_channel, parent, false)
    ...
    companion object {
        private val CHANNEL_COMPARATOR =
            object : DiffUtil.ItemCallback<LiveChannel>() {
