...
class CategoryTreeAdapter(
    ...
    ListAdapter<Pair<Category, Int>, CategoryTreeAdapter.CategoryViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_category_tree, parent, false)
