...
class SourcesAdapter(
    ...
    inner class SourceViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(source: StreamSource) {
            ...
            itemView.setOnClickListener { onSourceClick(source) }

            radioButton.setOnClickListener { onSourceClick(source) }

            editButton.setOnClickListener { onEditClick(source) }

            deleteButton.setOnClickListener { onDeleteClick(source) }
        }
    }
}
