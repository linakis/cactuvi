...
/**
 * Helper to detect user interaction and notify ReactiveUpdateManager.
 * Attach to RecyclerView or any view to track touch/scroll events.
 * 
 * Usage:
 * ```
...
object IdleDetectionHelper {
    ...
    /**
     * Attach idle detection to a RecyclerView.
     * Tracks scroll and touch events.
     */
